...
type DiseminasiRisetField = "nama" | "email" | "telp" | "institusi";
type FormStep = "details" | "verification" | "ticket";
...
const statusOptions = [
  {
    id: "dosen",
    title: "Dosen",
    description: "Hadir sebagai dosen.",
  },
  {
    id: "mahasiswa",
    title: "Mahasiswa",
    description: "Hadir sebagai mahasiswa.",
  },
];
...
export default function DiseminasiRisetForm() {
  const { user } = useAuth();
  ...
  const updateField = (field: DiseminasiRisetField, value: string) => {
    setNewUser((u) => ({
      ...u,
      [field]: value,
    }));
  ...
  const submitRegistration = async () => {
    ...
    // Simulate API call for frontend only requirement
    setTimeout(() => {
      setRegistrationId(`DR-${Math.random().toString(36).substring(2, 9).toUpperCase()}`);
      setStep("ticket");
  ...
  const downloadTicket = () => {
    ...
    ctx.fillText("Diseminasi Riset", 90, 140);
    ...
    ctx.fillText("Show this ticket during check-in.", 90, 620);

    const link = document.createElement("a");
    link.download = `diseminasi-riset-ticket-${registrationId}.png`;
  ...
  return (
    <section className="space-y-8">
      <nav aria-label="Diseminasi Riset registration progress" className="space-y-3">
          ...
          <FieldGroup className="gap-6">
            <div className="rounded-[8px] border border-border bg-muted/30 p-4">
              ...
              <p className="mt-1 text-sm leading-6 text-muted-foreground">
                ...
                for communication and certificate preparation.
              </p>
            </div>
            ...
            <Field className="gap-3">
              <FieldLabel>
                Status Civitas Akademika <span aria-hidden="true">*</span>
              </FieldLabel>
              <RadioGroup
          ...
          <div className="rounded-[8px] border border-border bg-card p-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  Your name and institution will be used for records and
            ...
            <dl className="mt-5 grid gap-4 text-sm sm:grid-cols-2">
              ...
              <div>
                <dt className="text-muted-foreground">No. Telepon/WhatsApp Aktif</dt>
              ...
              <div>
                <dt className="text-muted-foreground">Status Civitas Akademika</dt>
        ...
        <FieldGroup className="gap-6">
          <section className="rounded-[8px] border border-border bg-card p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-lg font-semibold">Your ticket is ready</h2>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Your Diseminasi Riset registration is saved. Download this free
