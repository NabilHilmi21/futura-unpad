            ...
            >
                <div
                    className={cn(
                        ...
                        isScrolled
                            ? "w-full max-w-7xl rounded-[2rem] border border-border/70 bg-background/80 backdrop-blur-xl px-6 py-2.5 shadow-sm"
                            : "w-full max-w-full rounded-none border border-transparent border-b-border/70 bg-background/95 backdrop-blur-xl px-6 py-3 sm:px-8"
                    )}
                >
                    ...
                    {user ? (
                        <div className="flex min-w-0 items-center gap-3">
                            {isAdmin && (
                                <Link
                                    ...
                                    className=""
                                >
                                    <Button className={cn("transition-all duration-700 ease-in-out", isScrolled && "rounded-[1.5rem]")}>Admin Dashboard</Button>
                                </Link>
                            )}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Button
                                asChild
                                size="sm"
                                className={cn("transition-all duration-700 ease-in-out", isScrolled && "rounded-[1.5rem]")}
                            >
